...
def classify(im):
    ...
    #break for complex images
    complexity = edges.sum()
    if complexity > 3000:
    ...
    if max_accum>= 200:
        print("max:", np.max(accumulator),"complexity:", complexity, 'brick ', end = "")
        return 'brick'
    elif max_accum >=120:
        print("max:", np.max(accumulator),"complexity:", complexity, 'cylinder ', end = "")
        return 'cylinder'
    else:
        print("max:", np.max(accumulator),"complexity:", complexity, 'ball ', end = "")
        return 'ball'